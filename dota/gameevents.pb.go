...
func (EBaseGameEvents) EnumDescriptor() ([]byte, []int) { return fileDescriptor18, []int{0} }
...
func (*CMsgVDebugGameSessionIDEvent) Descriptor() ([]byte, []int) { return fileDescriptor18, []int{0} }
...
func (*CMsgPlaceDecalEvent) Descriptor() ([]byte, []int) { return fileDescriptor18, []int{1} }
...
func (*CMsgClearWorldDecalsEvent) Descriptor() ([]byte, []int) { return fileDescriptor18, []int{2} }
...
func (*CMsgClearEntityDecalsEvent) Descriptor() ([]byte, []int) { return fileDescriptor18, []int{3} }
...
func (*CMsgSource1LegacyGameEventList) Descriptor() ([]byte, []int) { return fileDescriptor18, []int{5} }
...
func (*CMsgSource1LegacyGameEventListDescriptorT) Descriptor() ([]byte, []int) {
	return fileDescriptor18, []int{5, 1}
}
...
func (*CMsgSource1LegacyListenEvents) Descriptor() ([]byte, []int) { return fileDescriptor18, []int{6} }
...
func (*CMsgSource1LegacyGameEvent) Descriptor() ([]byte, []int) { return fileDescriptor18, []int{7} }
...
func (*CMsgSosStartSoundEvent) Descriptor() ([]byte, []int) { return fileDescriptor18, []int{8} }
...
func (*CMsgSosStopSoundEvent) Descriptor() ([]byte, []int) { return fileDescriptor18, []int{9} }
...
func (*CMsgSosStopSoundEventHash) Descriptor() ([]byte, []int) { return fileDescriptor18, []int{10} }
...
func (*CMsgSosSetSoundEventParams) Descriptor() ([]byte, []int) { return fileDescriptor18, []int{11} }
...
func (*CMsgSosSetLibraryStackFields) Descriptor() ([]byte, []int) { return fileDescriptor18, []int{12} }

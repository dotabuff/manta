...
type CMsgClientToGCTopPubMatchesRequest struct {
	XXX_unrecognized []byte `json:"-"`
}

func (m *CMsgClientToGCTopPubMatchesRequest) Reset()         { *m = CMsgClientToGCTopPubMatchesRequest{} }
func (m *CMsgClientToGCTopPubMatchesRequest) String() string { return proto.CompactTextString(m) }
func (*CMsgClientToGCTopPubMatchesRequest) ProtoMessage()    {}

type CMsgGCToClientTopMatchesResponse struct {
	Type             *CMsgGCToClientTopMatchesResponse_Type `protobuf:"varint,1,opt,name=type,enum=dota.CMsgGCToClientTopMatchesResponse_Type,def=1" json:"type,omitempty"`
...
func (m *CMsgQuickJoinCustomLobby_RegionPing) GetRegionCode() uint32 {
...
type CMsgDOTAChatMessage struct {
	...
	PlayerId                    *int32  `protobuf:"varint,13,opt,name=player_id,def=-1" json:"player_id,omitempty"`
	XXX_unrecognized            []byte  `json:"-"`
}
...
type CMsgDOTAGetPlayerMatchHistory struct {
	...
	Engine                 *ESourceEngine `protobuf:"varint,6,opt,name=engine,enum=dota.ESourceEngine,def=0" json:"engine,omitempty"`
...
const Default_CMsgDOTAGetPlayerMatchHistory_Engine ESourceEngine = ESourceEngine_k_ESE_Source1
...
func (m *CMsgDOTAGetPlayerMatchHistory) GetEngine() ESourceEngine {
	if m != nil && m.Engine != nil {
		return *m.Engine
	}
...
func init() {
	...
	proto.RegisterEnum("dota.CMsgGCToClientTopMatchesResponse_Type", CMsgGCToClientTopMatchesResponse_Type_name, CMsgGCToClientTopMatchesResponse_Type_value)

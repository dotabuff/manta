...
type CSODOTAPartyMember struct {
	...
	BannedHeroIds           []uint32 `protobuf:"varint,17,rep,name=banned_hero_ids,json=bannedHeroIds" json:"banned_hero_ids,omitempty"`
}
...
func (x *CSODOTAPartyMember) GetBannedHeroIds() []uint32 {
	if x != nil {

...
func (ENetworkDisconnectionReason) EnumDescriptor() ([]byte, []int) { return fileDescriptor33, []int{0} }
...
func init() { proto.RegisterFile("network_connection.proto", fileDescriptor33) }

...
func (ESteamDatagramMsgID) EnumDescriptor() ([]byte, []int) { return fileDescriptor24, []int{0} }
...
func (*CMsgSteamDatagramNoSession) Descriptor() ([]byte, []int) { return fileDescriptor24, []int{5} }
...
func (*CMsgSteamDatagramDiagnostic) Descriptor() ([]byte, []int) { return fileDescriptor24, []int{6} }
...
func (*CMsgSteamDatagramDataCenterState_DataCenter) Descriptor() ([]byte, []int) {
	return fileDescriptor24, []int{7, 1}
}
...
func (*CMsgSteamDatagramConnectionQuality) Descriptor() ([]byte, []int) {
	return fileDescriptor24, []int{10}
}
...
func (*CMsgSteamDatagramConnectionStatsClientToRouter) Descriptor() ([]byte, []int) {
	return fileDescriptor24, []int{11}
}
...
func (*CMsgSteamDatagramConnectionStatsRouterToClient) Descriptor() ([]byte, []int) {
	return fileDescriptor24, []int{12}
}
...
func (*CMsgSteamDatagramConnectionStatsServerToRouter) Descriptor() ([]byte, []int) {
	return fileDescriptor24, []int{14}
}
...
func (*CMsgSteamDatagramClientPingSampleRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor24, []int{15}
}

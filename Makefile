...
update-protobufs:
	...
	rm -rf dota/gametoolevents.proto dota/dota_gcmessages_common_bot_script.proto dota/steammessages_base.proto dota/steamdatagram_*.proto dota/steamnetworkingsockets_*.proto dota/tensorflow
